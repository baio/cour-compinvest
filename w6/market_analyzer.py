...
def analise_market(ls_values_file, ls_symbol, ls_graphic_file_out):
    ...
    sharpe, cum, std, mean = analise(values.copy())
    ...
    sym_sharpe, sym_cum, sym_std, sym_mean = analise(symbol_values.copy())
    ...
    plt.xlabel("Date")
    plt.savefig(ls_graphic_file_out, format='png')
